...
fetch('/7alltimetop10').then(response => response.json()).then(data => {
    ...
    const userColumn = document.querySelector(".username");
    const scoreColumn = document.querySelector(".score");
    const instaColumn = document.querySelector(".instagram");
    const facebookColumn = document.querySelector(".facebook");
    const twitterColumn = document.querySelector(".twitter");
