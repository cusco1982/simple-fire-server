...
if(pkey === '"-----BEGIN PRIVATE KEY-----\\n-----END PRIVATE KEY-----\n"'){
    console.log('pkey matches line');
}else{
    console.log('error: pkey doesnt match')
}

if(cemail === '"firebase-adminsdk-8a9co@cannabisstand-dfdcb.iam.gserviceaccount.com"'){
    console.log("cemail matches client_email env");
}else{
    console.log('error: cemail doesnt match env');
}
